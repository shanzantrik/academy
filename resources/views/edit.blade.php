    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/edit-application/{{$application->id}}" method="post" enctype="multipart/form-data">
                    	{{ csrf_field() }}
                    	<div class="row justify-content-center">
                    	    <div class="col-6">
                    	        <div class="float-right right">
                    	            <img src="/images/photo/{{$application->photo}}" height="150px" width="175px">
                    	        </div>
                    	    </div>
                    	    <div class="left col-6">
                    	        <img src="/images/sign/{{$application->signature}}" height="150px" width="175px">
                    	    </div>
                    	</div>
                    	...
                    	<div class="form-group row">
                           ...
                           <div class="col-md-2">
                                ...
                                <option @if($application->current_sem === 'Semester-3') selected 
                                @endif value="Semester-3">Semester 3</option>
                                <option @if($application->current_sem === 'Semester-4') selected 
                                @endif value="Semester-4">Semester 4</option>
                                </select>
                            </div>
                        </div>
