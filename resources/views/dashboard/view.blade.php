    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/admin/update-application/{{$application->id}}" method="post" enctype="multipart/form-data">
                    	{{ csrf_field() }}
                    	<div class="row justify-content-center">
                    	    <div class="col-6">
                    	        <div class="float-right right">
                    	            <img src="/images/photo/{{$application->photo}}" height="150px" width="160px">
                    	        </div>
                    	    </div>
                    	    <div class="left col-6">
                    	        <img src="/images/sign/{{$application->signature}}" height="30px" width="160px">
                    	    </div>
                    	</div>
