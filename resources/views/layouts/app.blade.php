...
<head>
    ...
    <title>REIMALIE ACADEMY COLLEGE</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="{{ route('moderatorlogin') }}">Moderator Login</a>
                            </li>
                        @else
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="/download-application-pdf/">My Application</a>
                        </li>
                        <li class="nav-item">
                                <a class="nav-link" href="/payment-history">My Payments</a>
                        </li>
